...
def test_enable_disable_helper_function(game_component):
    game_component.add_helper_function("dummy", dummy_helper_function)
...
def test_set_and_get_helper_function_contexts(game_component):
    game_component.add_helper_function("dummy", dummy_helper_function)
...
def test_get_helper_function(game_component):
    game_component.add_helper_function("dummy", dummy_helper_function)
...
def test_call_helper_function(game_component, capsys):
...
def test_run_helper_functions(game_component, capsys):
    def print_context(component, context, from_helper):
        print(f"Context: {context}")
...
def test_enable_and_disable(game_component):
...
def test_update(game_component):
    game_component.enable()
...
def test_handle_events(game_component):
    game_component.enable()
...
def test_disable_children(game_component):
    game_component.enable()
