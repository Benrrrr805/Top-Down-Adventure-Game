...
new_game_button = Button(
    ...
    y_coordinate=new_game_button_y,
    text="New Game", 
...
load_game_button = Button(
    ...
    height=button_height, 
    x_coordinate=button_x, 
    y_coordinate=load_game_button_y,
    text="Load Game", 
    text_size=button_text_size, 
    text_position=button_text_position,
    background_color=button_background_color)
...
settings_button = Button(
    name="settings_button", top_level=False, 
    width=button_width, 
    height=button_height, 
    x_coordinate=button_x,
    y_coordinate=settings_button_y,
    text="Settings", 
    text_size=button_text_size, 
    text_position=button_text_position, 
    background_color=button_background_color)
...
main_menu = Menu(
    ...
    x_coordinate=main_menu_x, 
    y_coordinate=main_menu_y, 
    text=main_menu_text, 
    text_size=main_menu_text_size, 
    text_position=main_menu_text_position, 
