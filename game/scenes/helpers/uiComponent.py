...
class UIComponent:
    def __init__(self, name, width, height, x_coordinate, y_coordinate, background_image=None, children=[], active=True, need_to_update=True, debug_color=BLACK):
    ...
    def draw(self):
        ...
        if self.debug and self.need_to_update:
