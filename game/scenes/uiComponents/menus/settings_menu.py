...
sound_button = Button("sound_button", button_width, button_height, button_x, sound_button_y,
                      text="Sound", text_size=button_text_size, text_position=button_text_position, 
                      background_color=button_background_color)

music_button = Button("music_button", button_width, button_height, button_x, music_button_y,
                      text="Music", text_size=button_text_size, text_position=button_text_position, 
                      background_color=button_background_color)

back_button = Button("back_button", button_width, button_height, button_x, back_button_y,
                     text="Back", text_size=button_text_size, text_position=button_text_position, 
                     background_color=button_background_color)

darkness_button = Button("darkness_button", button_width, button_height, button_x, darkness_button_y,
                         text="Darkness", text_size=button_text_size, text_position=button_text_position, 
                         background_color=button_background_color)

show_fps_button = Button("show_fps_button", button_width, button_height, button_x, show_fps_button_y,
